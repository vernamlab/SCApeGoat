...
file = FileParent("AnotherFile", "C:\\Users\\samka\\PycharmProjects\\SCLA_API_MQP\\Testing\\AnotherFile", existing=False)
...
# file = FileParent("AnotherFile", "C:\\Users\\samka\\PycharmProjects\\SCLA_API_MQP\\Testing\\AnotherFile", existing=True)
# print(file.get_experiment("Experiment1").get_dataset("fixed").read_all()[0])
#
# file = FileParent("AnotherFile", "C:\\Users\\samka\\PycharmProjects\\SCLA_API_MQP\\AnotherFile", existing=True)
#
# print(file.get_experiment("Experiment1").get_dataset("fixed").read_all()[0])
