...
file = FileParent("AnotherFile", "C:\\Users\\samka\\PycharmProjects\\MQP\\SCLA_API_MQP\\", existing=False)

experiment_1 = file.add_experiment(name="Experiment1")
dataset_1 = experiment_1.add_dataset(name="random", data_to_add=random)

experiment_2 = file.add_experiment(name="Experiment2")
dataset_2 = experiment_2.add_dataset(name="fixed", data_to_add=fixed)
